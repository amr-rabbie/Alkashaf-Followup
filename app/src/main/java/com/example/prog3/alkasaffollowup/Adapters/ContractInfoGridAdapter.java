...
public class ContractInfoGridAdapter extends BaseAdapter {

    Context context; List<ClientsScreens> screens;
    public ContractInfoGridAdapter(Context context, List<ClientsScreens> screens) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView ==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.contract_info_row,parent,false);
