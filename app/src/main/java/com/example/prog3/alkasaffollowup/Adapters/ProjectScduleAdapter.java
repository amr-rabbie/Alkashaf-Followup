...
/**
 * Created by prog3 on 3/19/2018.
 */

public class ProjectScduleAdapter  extends BaseAdapter {

    Context context; List<ProjectFee> projfees;
    public ProjectScduleAdapter(Context context, List<com.example.prog3.alkasaffollowup.Model.ProjectFees.ProjectFee> projfees) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtvalue.setText(projectFee.getValue());
